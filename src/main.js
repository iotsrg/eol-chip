import { initNav, tag, severityTag, badgeRow, renderSourcesFooter } from './common.js?v=16'
...
Promise.all([
  fetch('./data/search_index.json?v=16').then(r => r.json()),
  fetch('./data/meta.json?v=16').then(r => r.ok ? r.json() : null).catch(() => null),
])
  .then(([data, meta]) => {
